          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-text-secondary dark:text-text-secondary-dark">Velocity</span>
                <span className="font-medium text-text-primary dark:text-text-primary-dark">
                  {member.velocity}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-text-secondary dark:text-text-secondary-dark">On-Time</span>
                <span className="font-medium text-success dark:text-success-dark">
                  {Math.round(member.onTimeRate * 100)}%
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-text-secondary dark:text-text-secondary-dark">Productivity</span>
                <span className="font-medium text-text-primary dark:text-text-primary-dark">
